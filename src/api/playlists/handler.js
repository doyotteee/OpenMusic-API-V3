...
class PlaylistsHandler {
  ...
  async postSongToPlaylistHandler(request, h) {
    ...
    const { id: credentialId } = request.auth.credentials;    await this._service.verifyPlaylistAccess(playlistId, credentialId);
  ...
  async getPlaylistSongsHandler(request) {
    ...
    const data = await this._service.getPlaylistSongs(playlistId);
